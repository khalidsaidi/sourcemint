...
SourceMint (SRCMNT) is an open-source ERC-20 token contract built with Foundry and deployed on Base mainnet with a fixed initial supply minted at deployment.
